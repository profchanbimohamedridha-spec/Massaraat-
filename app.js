...
const ADHKAR = [
  ...
  {n:34, bab:"الاستغفار", dhikr:"قال النبي ﷺ: «إني لأستغفر الله في اليوم - مئة مرة -».", daleel:"رواه مسلم."},
  {n:36, bab:"من نزل منزلاً", dhikr:"قال النبي ﷺ: «من نزل منزلاً، ثم قال: أعوذ بكلمات الله التامّات من شرّ ما خلق؛ لم يضرّه شيء حتى يرتحل من منزله ذلك».", daleel:"رواه مسلم."},
  {n:37, bab:"عند التعجب من شيء", dhikr:"يقول: «سبحان الله». ويقول: «الله أكبر».", daleel:"متفق عليه."},
  {n:38, bab:"تشميت العاطس", dhikr:"قال النبي ﷺ: «إذا عطس أحدكم؛ فليقل: الحمد لله. وليقل له أخوه - أو صاحبه -: يرحمك الله. فإذا قال له: يرحمك الله؛ فليقل: يهديكم الله، ويصلح بالكم».", daleel:"رواه البخاري."},
  {n:39, bab:"الغضب", dhikr:"استبَّ رجلان عند النبي ﷺ، فجعل أحدهما يغضب ويحمرّ وجهه. فنظر إليه النبي ﷺ، فقال: «إني لأعلم كلمة لو قالها لذهب عنه ذا: أعوذ بالله من الشيطان الرجيم».", daleel:"متفق عليه."},
  {n:40, bab:"الدعاء لمن صنع معروفاً", dhikr:"قال النبي ﷺ: «من صنع إليكم معروفًا فكافئوه. فإن لم تجدوا ما تكافئونه؛ فادعوا له حتى تروا أنكم قد كافأتموه».", daleel:"رواه أبو داود."},
  {n:41, bab:"كفارة المجلس", dhikr:"قال النبي ﷺ: «من جلس في مجلس، فكثر فيه لغَطُه، فقال - قبل أن يقوم من مجلسه ذلك -: سبحانك اللهم وبحمدك، أشهد أن لا إله إلا أنت، أستغفرك، وأتوب إليك؛ إلا غُفر له ما كان في مجلسه ذلك».", daleel:"رواه الترمذي."},
];
